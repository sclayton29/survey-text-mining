...
corpus_lda <-LDA(dtm.new, k=2, control = list(seed =150)) 
...
family = "parent|family|mother|father"
career = "career|job"
knowledge = "knowledge|learn|education"
money = "money|salary|pay|financ|income|debt"
location = "distance|location|home|close"
